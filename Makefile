...
.PHONY: dist
dist: dist/protocol-lib-0.8.0.tar.gz dist/protocol_lib-0.8.0-py3-none-any.whl

dist/protocol-lib-0.8.0.tar.gz dist/protocol_lib-0.8.0-py3-none-any.whl: $(shell find protocol_lib -type f -name '*.py')
	poetry build
